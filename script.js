...
const translations = {
    en: {
        ...
        privacyNoticeLabel: "Privacy Protection",
        privacyNoticeText: "Your identity and personal information are strictly confidential. We guarantee that your submitted personal data will never be disclosed to any third party in any form.",
        formName: "Full Name *",
        formCompany: "Company *",
...
,        benefitCompensationTitle: "有竞争力的报酬",
        ...
        privacyNoticeLabel: "隐私保护",
        privacyNoticeText: "您的身份和个人信息将被严格保密。我们承诺您提交的个人信息不会以任何形式对外泄露。",
        formName: "姓名 *",
        formCompany: "公司 *",
        formEmail: "邮箱地址 *",
        formInterest: "我感兴趣的是 *",
