...
const translations = {
    en: {
        ...
        statConsultations: "Consultations Delivered",
        ...
        aboutTitle: "Connecting Decision-Makers with Industry Intelligence",
        aboutDesc1: "Meridian Expert Network was founded on a simple belief: the most valuable insights come from those with firsthand experience. In a world saturated with data, we provide access to the nuanced, contextual knowledge that drives superior decisions.",
        aboutDesc2: "Our platform connects institutional investors, consulting firms, and corporate strategists with verified industry experts across 150+ sectors. Every connection is carefully curated to ensure relevance, compliance, and actionable intelligence.",
        valueIntegrity: "Integrity",
        valuePrecision: "Precision",
        valuePartnership: "Partnership",
        aboutImageText: "Strategic Advisory",
        sectionServices: "Services",
        servicesTitle: "Tailored Solutions for Every Research Need",
        ...
        expertsDesc: "Join our network of 50,000+ professionals and get paid for sharing your industry knowledge. Set your own schedule, choose your engagements, and connect with leading investors and strategists seeking your insights.",
        ...
        expertStatExperts: "Active Experts",
        expertStatPayment: "Average Payment",
    ...
    zh: {
        ...
        step3Title: "连接学习",
        step3Desc: "按您的时间安排咨询，获取可执行的洞察",
        sectionAbout: "关于我们",
        aboutTitle: "连接决策者与行业智能",
        aboutDesc1: "Meridian 专家网络建立在一个简单信念之上：最有价值的洞察来自拥有第一手经验的人。在一个数据饱和的世界里，我们提供推动卓越决策的细微、情境化的知识。",
        aboutDesc2: "我们的平台连接机构投资者、咨询公司和企业战略家与150多个行业的认证专家。每一次连接都经过精心策划，以确保相关性、合规性和可执行的情报。",
        valueIntegrity: "诚信",
        valuePrecision: "精准",
        valuePartnership: "合作",
        aboutImageText: "战略咨询",
        sectionServices: "服务",
        servicesTitle: "为每个研究需求量身定制解决方案",
        badgePopular: "最受欢迎",
        ...
        expertsDesc: "加入我们的50,000+专业人士网络，分享您的行业知识并获得报酬。自主安排时间，选择参与项目，与寻求您洞察的领先投资者和战略家建立联系。",
        ...
        expertsCta: "申请成为专家",
        expertStatRate: "时薪范围",
        expertStatExperts: "活跃专家",
        expertStatPayment: "平均付款时间",
        sectionContact: "联系我们",
        contactTitle: "与我们联系",
